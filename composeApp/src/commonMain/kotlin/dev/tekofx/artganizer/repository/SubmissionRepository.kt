...
interface SubmissionRepositoryInterface {
    ...
    suspend fun deleteSubmission(submission: SubmissionWithArtist)
    suspend fun deleteSubmissions(submissions: List<SubmissionWithArtist>)
}
...
class SubmissionRepository(
    ...
    // DELETE
    override suspend fun deleteSubmission(submission: SubmissionWithArtist) {
        // Delete submission
